...
import DistributionVizPanel from "./DistributionVizPanel"
import {MAX_RAW_FILE_VIEW_SIZE} from "../../FileManagerAppConfig"

function DistributionViewer(props) {
    ...
    return (
        <div className="flex flex-col overflow-hidden h-full ">
            ...
            {selectedTab === 4 && <div className="p-4 overflow-auto flex-grow"><DistributionVizPanel meta={props.meta}/></div>}
        </div>
    )
}

export default withReducer("DistributionViewerApp", reducer)(DistributionViewer);