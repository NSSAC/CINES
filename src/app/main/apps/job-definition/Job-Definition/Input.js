        ...
        <div className="my-32">
          <label className="my-32 ">
            ...
            {props.formData[1].outputFlag ? (
              <Button
                onClick={showFolderManagerDialog}
          ...
          {props.formData[1].outputFlag ? (
            <span className="my-32 ">
              {folderChosenPath == "" ? (
                ...
                <b className="folderPath" onChange={props.changed}>
                  {folderChosenPath}
                </b>
              )}
            </span>
          ) : (
            <span className="my-32 folderPath">
              {fileChosen == "" ? (
                "No file chosen"
              ) : (
                <b onChange={props.changed}>{fileChosen}</b>
              )}
            </span>
          )}
        </div>
      ...
      content={
        <div className="flex content">
          ...
          {props.formData[1].description && (
            <Tooltip
              title={<h4>{props.formData[1].description}</h4>}
              placement="right"
            >
