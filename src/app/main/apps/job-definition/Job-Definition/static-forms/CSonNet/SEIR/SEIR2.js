                    ...
                    <div>
                          <Grid style={childGrid} item container xs={12} >
                                                <TextFieldFormsy
                                                    ...
                                                    required
                                                />
                                                {description(modelJSON.models.SEIR.submodels['fixed exposed stochastic infectious'].rules[0].input.weight_probability_column_name.description)}
                                            </Grid>
                                 <Grid style={childGrid} item container xs={12} >
                                                <TextFieldFormsy
                                                    className="my-12 inputStyle1"
                                                    ...
                                                    required
                                                />
                                                {description(modelJSON.models.SEIR.submodels['fixed exposed stochastic infectious'].rules[1].input.time_duration.description)}
                                            </Grid>
                                            <Grid style={childGrid} item container xs={12} >
                                                <TextFieldFormsy
                                                    className="my-12 inputStyle1"
                                                    ...
                                                    required
                                                />
                                                {description(modelJSON.models.SEIR.submodels['fixed exposed stochastic infectious'].rules[2].input.probability.description)}
                                            </Grid>
