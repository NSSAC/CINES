                    ...
                    <div>
                                 <Grid style={childGrid} item container xs={12} >
                                                <TextFieldFormsy
                                                    ...
                                                    required
                                                />
                                                {description(modelJSON.models.SIR.submodels['fixed infectious'].rules[0].input.weight_probability_column_name.description)}
                                            </Grid>
                                            <Grid style={childGrid} item container xs={12} >
                                                <TextFieldFormsy
                                                    className="my-12 inputStyle1"
                                                    ...
                                                    required
                                                />
                                                 {description(modelJSON.models.SIR.submodels['fixed infectious'].rules[1].input.time_duration.description)}
                                            </Grid>
