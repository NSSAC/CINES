                                ...
                                <TableRow>
                                    ...
                                    <TableCell className="max-w-64 w-64 p-0 text-center">
                                        ...
                                        <div>
                                            ...
                                            >
                                                <MenuItem onClick={handleDeleteAll} disabled={tokenData && tokenData.roles && tokenData.roles.indexOf('superadmin') !== -1 ? false : !token || (selected.some(selectedItem => token && tokenData.sub !== selectedItem.owner_id))}>
                                                ...
                                                <MenuItem style={{ height: '36px' }} onClick={() => handleMoveAll()} disabled={tokenData && tokenData.roles && tokenData.roles.indexOf('superadmin') !== -1 ? false : !token || (selected.some(selectedItem => token && tokenData.sub !== selectedItem.owner_id))}>
                                                    <IconButton className='py-0 pl-0' style={{ pointerEvents: 'none' }}>
